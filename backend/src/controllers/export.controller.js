...
export const exportProducts = asyncHandler(async (req, res) => {
  ...
  await exportService.exportProductsCSV(req.organizationId, res);
});
...
export const exportSales = asyncHandler(async (req, res) => {
  ...
  await exportService.exportSalesCSV(req.organizationId, res);
});
...
export const exportMovements = asyncHandler(async (req, res) => {
  ...
  await exportService.exportMovementsCSV(req.organizationId, res);
});
