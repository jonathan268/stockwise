  ...
  const plans = [
    {
      ...
      highlight: false,
      features: [
        { text: "Jusqu'à 50 références produits", included: true },
        { text: "2 utilisateurs", included: true },
        { text: "1 point de stockage", included: true },
        { text: "5 prédictions IA / mois", included: true },
        { text: "Alertes de rupture basiques", included: true },
    ...
    },
    {
      ...
      tagline: "Le choix des PME en croissance",
      monthlyPrice: 15000,
      annualPrice: 12000,
      priceLabel: null,
      ...
      badge: "Recommandé",
      features: [
        { text: "Jusqu'à 200 références", included: true },
        { text: "5 utilisateurs", included: true },
        { text: "2 points de stockage", included: true },
        { text: "50 prédictions IA / mois", included: true },
        { text: "Analyse complète des lots (DLC)", included: true },
    ...
    },
    {
      ...
      tagline: "Gestion multi-sites & IA avancée",
      monthlyPrice: 45000,
      annualPrice: 36000,
      priceLabel: null,
      ...
      highlight: false,
      features: [
        { text: "Jusqu'à 1000 références", included: true },
        { text: "15 utilisateurs", included: true },
        { text: "5 points de stockage", included: true },
        { text: "200 prédictions IA / mois", included: true },
        { text: "Détection d'anomalies (IA)", included: true },
        { text: "Personnalisation (Branding)", included: true },
            ...
            {[
              {
                ...
                title: "IA Prédictive (Gemini)",
                text: "Notre moteur analyse vos ventes et mouvements pour prédire vos besoins réels. Plus de commandes à l'aveugle.",
                custom: 0,
              },
              {
                icon: <BellRing size={26} className="text-warning" />,
                title: "Alertes & Péremptions",
                text: "Soyez notifié du stock bas et des produits proches de l'expiration (DLC) pour minimiser vos pertes.",
                custom: 1,
              },
              {
                icon: <Smartphone size={26} className="text-secondary" />,
                title: "Paiements NotchPay",
                text: "Gérez votre abonnement en quelques clics via Mobile Money (Orange, MTN) ou carte bancaire.",
                custom: 2,
              },
              {
                icon: <ShoppingCart size={26} className="text-success" />,
                title: "Suivi des Commandes",
                text: "Gérez le cycle complet de commande fournisseur et client, du brouillon à la livraison finale.",
                custom: 3,
              },
              {
                icon: <BarChart3 size={26} className="text-info" />,
                title: "Analyses de Performance",
                text: "Visualisez vos produits les plus rentables et détectez les anomalies de stock grâce à nos tableaux de bord.",
                custom: 4,
              },
              {
                icon: <Globe size={26} className="text-accent" />,
                title: "Accès Multi-Sites",
                text: "Contrôlez plusieurs points de vente ou entrepôts depuis une interface unique et centralisée.",
                custom: 5,
              },
              {
                icon: <Users size={26} className="text-primary" />,
                title: "Gestion d'Équipe",
                text: "Attribuez des rôles précis (Admin, Manager, Vendeur) pour sécuriser vos données et vos opérations.",
                custom: 6,
              },
              {
                icon: <Building2 size={26} className="text-secondary" />,
                title: "Annuaire Fournisseurs",
                text: "Gardez une trace de tous vos partenaires, leurs coordonnées et l'historique de vos échanges.",
                custom: 7,
              },
              {
                icon: <ShieldCheck size={26} className="text-success" />,
                title: "Sécurité de Grade Bancaire",
                text: "Vos données professionnelles sont chiffrées et sauvegardées quotidiennement sur nos serveurs sécurisés.",
                custom: 8,
              },
            ].map((feat) => (
