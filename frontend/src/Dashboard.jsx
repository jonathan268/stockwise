...
const Dashboard = () => {
  ...
  const recentActivity = [
    { id: 1, action: 'Entrée stock', product: 'iPhone 14 Pro', quantity: 50, time: 'Il y a 2h' },
    { id: 2, action: 'Sortie stock', product: 'MacBook Air M2', quantity: 15, time: 'Il y a 3h' },
    { id: 3, action: 'Alerte IA', product: 'Stock faible détecté', quantity: null, time: 'Il y a 5h' },
    { id: 4, action: 'Entrée stock', product: 'Samsung Galaxy S23', quantity: 30, time: 'Il y a 6h' },
  ];
  ...
  return (
    <div className="flex h-screen bg-base-200">
      {/* Sidebar */}
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-base-100 transition-all duration-300 shadow-xl`}>
        <div className="flex items-center justify-between p-4 border-b border-base-300">
          {sidebarOpen && <h1 className="text-xl font-bold text-secondary">STOCKWISE</h1>}
          <button 
        ...
        <nav className="p-4 space-y-2">
          ...
          <button className="btn btn-ghost w-full justify-start gap-3">
            <Activity size={20} />
            {sidebarOpen && <span>Analytiques IA</span>}
          </button>
        </nav>
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <div className="flex items-center gap-1 mt-2">
                        ...
                        <span className="text-sm opacity-70">vs mois dernier</span>
                      </div>
                    </div>
            ...
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold text-sm opacity-70">Suggestions IA</h3>
                  ...
                  {recentActivity.map((activity) => (
                    <div key={activity.id} className="flex items-start gap-4 p-3 hover:bg-base-200 rounded-lg transition-colors">
                      <div className={`p-2 rounded-lg ${
                        activity.action === 'Entrée stock' ? 'bg-success' :
                        activity.action === 'Sortie stock' ? 'bg-warning' : 'bg-info'
                      } bg-opacity-20`}>
                      ...
                      <div className="flex-1">
                        ...
                        {activity.quantity && (
                          <p className="text-sm">Quantité: <span className="font-semibold">{activity.quantity}</span></p>
                        )}
                      </div>
                    ...
                    <div key={index} className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm opacity-70">Stock: {product.stock} • Valeur: {product.value}</p>
                        </div>
